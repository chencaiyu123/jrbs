...
return array(
    ...
    'TMPL_PARSE_STRING'       => array( '__PUBLIC__' => __ROOT__ . '/Public',
                                        ...
                                        '__EDITOR__' => __ROOT__ . '/Public/editor'),          // 模板引擎要自动替换的字符串，必须是数组形式。
...
//    'TMPL_EXCEPTION_FILE'     => THINK_PATH.'/Tpl/ThinkException.tpl.php',// 异常页面的模板文件
    ...
    'URL_PATHINFO_MODEL'      => 1,       // PATHINFO 模式,使用数字1、2、3代表以下三种模式:
    ...
    /*邮件验证*/
    'MAIL_HOST' =>'smtp.163.com',//smtp服务器的名称（这里我使用qq的smtp，就是5.4中看到的那个内容）</span>
    'MAIL_SMTPAUTH' =>TRUE, //启用smtp认证
    'MAIL_USERNAME' =>'codeting@163.com',//你的邮箱名
    'MAIL_FROM' =>'codeting@163.com',//发件人地址（与你的邮箱名相同）
    'MAIL_FROMNAME'=>'大自然搬运工',//发件人姓名
    'MAIL_PASSWORD' =>'163shouquan',//邮箱密码（这里注意要是你开通时的独立密码）</span>
